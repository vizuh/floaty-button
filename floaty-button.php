...
$options = get_option( self::OPTION_KEY );
		...
		if ( 'whatsapp' === ( $options['button_template'] ?? '' ) && empty( $options['whatsapp_phone'] ) ) {
		return;
		}
...
return;
		...
		$inline = "/* Scope your selectors with #floaty-button-container for safety */\n" . $custom_css;
		$inline = apply_filters( 'floaty_button_inline_css', $inline, $options );
